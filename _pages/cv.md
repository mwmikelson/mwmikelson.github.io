...
<div class="cv-item">
  ...
  <ul>
    <li>Working under Professor Christopher J. Fariss.</li>
...
<div class="cv-item">
  ...
  <ul>
    <li>Working under Professors Paula D. McClain and David A. Siegel.</li>
...
<div class="cv-item">
  ...
  <ul>
    <li>Working under Professor Emily Hencken Ritter.</li>
...
<div class="cv-section-title">Conference Presentations & Working Papers</div>
...
<div class="cv-section-title">Other Employment & Extracurricular Activities</div>

<div class="cv-item">
  <div class="cv-row">
    <div class="cv-title">Data Editor & Election Night Reporter</div>
    <div class="cv-date">2018 – Present</div>
  </div>
  <div class="cv-sub">Decision Desk HQ</div>
  <ul>
...
<div class="cv-item">
  <div class="cv-row">
    <div class="cv-title">Data Editor & Data Journalist</div>
    <div class="cv-date">2022 – 2025</div>
  </div>
  <div class="cv-sub">The Michigan Daily</div>
  <ul>
...
<div class="cv-item">
  <div class="cv-row">
    <div class="cv-title">Team Member</div>
    <div class="cv-date">2021 – 2024</div>
  </div>
  <div class="cv-sub">Michigan Policy Debate Team</div>
  <ul>
...
<div class="cv-item">
  <div class="cv-row">
    <div class="cv-title">Member</div>
    <div class="cv-date">2021</div>
  </div>
  <div class="cv-sub">Michigan Foreign Policy Council</div>
  <ul>
...
<div class="cv-item">
  ...
  <div class="cv-sub">University of Michigan (Project: "Militarization and Interstate Conflict")</div>
</div>
...
<div class="cv-item">
  ...
  <div class="cv-sub">Pinnacle College Media Awards (Project: "How Walkable Is Your Block? The Michigan Daily")</div>
</div>
...
<div class="cv-item">
  ...
  <div class="cv-sub">R, Stata, Python, C++, QGIS 3</div>
</div>

<div class="cv-item">
  <div class="cv-row">
    <div class="cv-title">Quantitative Methods</div>
  </div>
  <div class="cv-sub">OLS/Multivariate/Logit/Probit Regression Modeling, Latent variable modeling, Heckman Selection Modeling, Content analysis, Data cleaning</div>
</div>