...
description: >
  ...
  <span onclick="window.location.href='/assets/pdf/ml-syllabus.pdf'; event.preventDefault(); event.stopPropagation();" class="course-btn-custom preview-only-btn"><i class="fa-solid fa-file-lines"></i> Syllabus</span>
  <span onclick="window.location.href='/assets/pdf/ml-section-syllabus.pdf'; event.preventDefault(); event.stopPropagation();" class="course-btn-custom preview-only-btn"><i class="fa-solid fa-file-lines"></i> Section Syllabus</span>
