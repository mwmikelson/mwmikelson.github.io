...
description: >
  ...
  <span onclick="window.location.href='/assets/pdf/ps-3-syllabus.pdf'; event.preventDefault(); event.stopPropagation();" class="course-btn-custom preview-only-btn"><i class="fa-solid fa-file-pdf"></i> Syllabus</span>
  <span onclick="window.location.href='/assets/pdf/ps-3-section-syllabus.pdf'; event.preventDefault(); event.stopPropagation();" class="course-btn-custom preview-only-btn"><i class="fa-solid fa-file-pdf"></i> Section Syllabus</span>
